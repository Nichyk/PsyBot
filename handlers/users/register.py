...
from keyboards import kb_cancel_reg
from keyboards.inline import ikb_signup
...
async def get_name(message: types.Message, state: FSMContext):
    ...
    await message.answer(f'{answer}, укажите, пожалуйста, Ваш номер телефона для связи.')
...
async def get_email(message: types.Message, state: FSMContext):
    ...
    await message.answer('Регистрация успешно завершена.\n'
                         'Теперь можно приступать к записи.', reply_markup=ikb_signup)
